...
urlpatterns = [
    ...
    path('', RedirectView.as_view(url = "http://DearCovid.ga/DearCovid/1"), name='index'),
    # path('DearCovid', views.messages, name='messages'),
    path('DearCovid', RedirectView.as_view(url = "http://DearCovid.ga/DearCovid/1"), name='messages'),
